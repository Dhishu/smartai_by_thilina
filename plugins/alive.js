        ...
        if (false) {
          ...
          for (const jsonStr of jsonMatches) {
            try {
              ...
              await c.sendButton(jid, 'මදක් සිටින්න!', '', null, []);
              await c.sendPresenceUpdate('recording', jid);
