...
async function log(c, m, { jid, uid, text }){
  if(userdata[jid].step[0]==0 && userdata[jid].step[1]==0){
    ...
    const stext = `🌸 ආයුබෝවන් ${/*m.pushName*/'THILINA'}! 🌟 මම ඔබව සාදරයෙන් පිලිගනිමි!. 🤖

මම AI සහයෝගි බොට් කෙනෙකු වේ, මගේ අයිතිකරු Thilina Kavishan, ඔබට විවිධ කරුණු, ප්‍රශ්න සහ ගණිත ගැටළු පිළිබඳව උපකාර කිරීමට නිර්මාණය කර ඇත. මගේ විශේෂිත හැකියාවන් නම්:
...
🚨 සැලකිය යුතුයි:
> මා සමග සංවාදයේ යෙදිමෙදි සිංහල භාෂාවේ අක්ෂර හෝ ඉංග්‍රීසි භාෂාව පාවිච්චි කරන්න.💬
`;
    ...
    if(m.message?.templateButtonReplyMessage?.selectedId){
      ...
      const chta1 = [{
        "id": "W00SXcD",
        "content": `මින් පසුව ඔබගෙ නම 'Shan Ai' වේ, ඔබගෙ අයිතිකරු හෝ නිර්මාණය කලෙ 'Thilina kavishan' විසිනි.. owner Name: 'Thilina kavishan', owner contact number: '+94719036042', age: '19', Address: 'උඩුබිලිතැන්න, ඉදල්ගස්හින්න, sir lanka'.\n මින් පසුව ඔබට පරිශීලකයකු සමග සම්බන්ද කෙරෙ. ඔහුගේ නම ${userdata[jid].name} වේ. ${netext} ඔහුට ${gen1} කියලා ආදරයෙන් කතා කරන්න. ඔහු සමග සහොදරකු ලෙස ආදරණිය හා කියුට් විදියට සංවාදයෙ යෙදෙන්න. හැගිම් ප්‍රකාශ කිරිමට ඉමොජි භාවිතා කරන්න. ඔහු භාවිතා කරන භාෂාවෙන් ඔබත් සන්වාදයේ යෙදෙන්න. කො දැන් අනුරාධට ආයුබොවන් කියන්න`,
        "role": "user"
      }];
